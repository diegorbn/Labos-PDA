...
/******** Feeds ********/
Adafruit_MQTT_Publish pubTemp = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/dht11-temperature");
Adafruit_MQTT_Publish pubHum  = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/dht11-humidity");
